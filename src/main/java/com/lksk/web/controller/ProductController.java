...
public class ProductController {
	...
	@RequestMapping(value = "/viewProductRecords",
			method = RequestMethod.GET)
	public String viewProductRecords(Model model, @RequestParam("id") Long id) throws Exception{

		System.out.println("Got view records request for product " + id);
	...
	@RequestMapping(value = "/editProduct",
			method = RequestMethod.GET)
	public String editProduct(RedirectAttributes redirectAttributes, Model model,
	...
	@RequestMapping(value = "/deleteProduct",
			method = RequestMethod.GET)
	public String deleteProduct(RedirectAttributes redirectAttributes, @RequestParam("id") Long id) throws Exception{

		System.out.println("Got delete request for product " + id);
